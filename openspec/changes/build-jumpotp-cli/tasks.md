...
- [ ] 12.5 With separate stable-release authorization, preserve the failed `v0.1.0` tag, publish `v0.1.1` platform packages then root through OIDC, create the matching GitHub Release, and verify provenance, versions, dist-tags, checksums, clean installation, update, and uninstall.
